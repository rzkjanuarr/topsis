...
if (isset($_POST['simpan'])) {
    ...
    if ($cek > 0) {
        if (password_verify($_POST['password'], $data['password'])) {
            ...
            header("location:admin.php?halaman=prioritas_order");
        } else {
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Perhitungan Order Metode Topsis</h1>
                                        <h5 class="h5 text-gray-500 mb-4">awali harimu dengan login</h5>
                                    </div>
                                    <form class="user" method="post" action="">
                                        ...
                                        <button type="submit" name="simpan" class="btn btn-primary btn-user btn-block">ga dulu</button>
                                    </form>
                                </div>
                            </div>
                        </div>

        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="card">
                        <div class="card-body">
                            <a href="?halaman=daftar_transaksi" class="btn btn-primary mb-3">Daftar Transaksi</a>
                            ...
                            <form method="post" id="myform" action="">
                                <table class="table table-sm" width="100%">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control form-control-sm hp" name="no_hp"
                                                required>
                                        </div>
                                        ...
                                        <tr>
                                            <td>
                                                <button type="submit" name="simpan"
                                                    class="btn btn-sm btn-success">Simpan Data</button>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
